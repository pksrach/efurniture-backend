...
from app.routes.frontend.frontend_notification_router import frontend_notification_router
from app.routes.frontend.frontend_order_router import frontend_order_router
from app.routes.frontend.frontend_payment_method_router import frontend_payment_method_router
...
frontend_router.include_router(frontend_payment_method_router, tags=["Frontend Payment Method API"])
...
frontend_router.include_router(frontend_notification_router, tags=["Frontend Notification API"])
