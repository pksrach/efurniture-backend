...
async def get_users(session: AsyncSession = Depends(get_session), pagination: PaginationParam = Depends(PaginationParam)):
    return await get_all_users(session, pagination)
