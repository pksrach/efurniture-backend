...
async def get_all_media_storage_by_ref_id(reference_id: str, entity_type: Optional[str],
                                          session: AsyncSession = Depends(get_session)):
...
async def get_media_storage_by_ref_id(reference_id: str, entity_type: Optional[str],
                                      session: AsyncSession = Depends(get_session)):
...
async def get_all_media_storage_by_entity_type(entity_type: Optional[str],
                                               session: AsyncSession = Depends(get_session)):
