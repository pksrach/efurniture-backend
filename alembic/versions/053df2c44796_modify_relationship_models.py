...
def upgrade() -> None:
    ...
    op.add_column('brands', sa.Column('created_by', sa.UUID(), nullable=True))
    op.add_column('brands', sa.Column('updated_at', sa.DateTime(), nullable=True))
    op.add_column('brands', sa.Column('updated_by', sa.UUID(), nullable=True))
    ...
    op.add_column('colors', sa.Column('id', sa.UUID(), nullable=False))
    op.add_column('colors', sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False))
    op.add_column('colors', sa.Column('created_by', sa.UUID(), nullable=True))
    op.add_column('colors', sa.Column('updated_at', sa.DateTime(), nullable=True))
    op.add_column('colors', sa.Column('updated_by', sa.UUID(), nullable=True))
    ...
    op.add_column('order_details', sa.Column('created_by', sa.UUID(), nullable=True))
    op.add_column('order_details', sa.Column('updated_at', sa.DateTime(), nullable=True))
    op.add_column('order_details', sa.Column('updated_by', sa.UUID(), nullable=True))
    ...
    op.add_column('payment_methods', sa.Column('created_by', sa.UUID(), nullable=True))
    op.add_column('payment_methods', sa.Column('updated_at', sa.DateTime(), nullable=True))
    op.add_column('payment_methods', sa.Column('updated_by', sa.UUID(), nullable=True))
    ...
    op.add_column('product_prices', sa.Column('created_by', sa.UUID(), nullable=True))
    op.add_column('product_prices', sa.Column('updated_at', sa.DateTime(), nullable=True))
    op.add_column('product_prices', sa.Column('updated_by', sa.UUID(), nullable=True))
    ...
    op.create_foreign_key(None, 'product_prices', 'colors', ['d'], ['color_id'])
    op.add_column('product_rates', sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False))
    op.add_column('product_rates', sa.Column('created_by', sa.UUID(), nullable=True))
    op.add_column('product_rates', sa.Column('updated_at', sa.DateTime(), nullable=True))
    op.add_column('product_rates', sa.Column('updated_by', sa.UUID(), nullable=True))
    ...
    op.add_column('staffs', sa.Column('created_by', sa.UUID(), nullable=True))
    op.add_column('staffs', sa.Column('updated_at', sa.DateTime(), nullable=True))
    op.add_column('staffs', sa.Column('updated_by', sa.UUID(), nullable=True))
...
def downgrade() -> None:
    ...
    op.create_foreign_key('product_prices_color_id_fkey', 'product_prices', 'colors', ['id'], ['id'])
    ...
    op.add_column('colors', sa.Column('id', sa.UUID(), autoincrement=False, nullable=False))
    op.create_index('ix_colors_color_id', 'colors', ['id'], unique=False)
    ...
    op.drop_column('colors', 'id')
    op.create_index('ix_categories_category_id', 'categories', ['id'], unique=False)
    ...
    op.create_index('ix_brands_brand_id', 'brands', ['id'], unique=False)
