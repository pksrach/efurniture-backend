...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_brands_brand_id'), 'brands', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_categories_category_id'), 'categories', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_colors_color_id'), 'colors', ['id'], unique=False)
